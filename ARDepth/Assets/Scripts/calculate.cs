   ...
   /* Vector3[] GetColliderVertexPositions(GameObject gameObject) {
    ...
    void OnDrawGizmosSelected()
    {
        ...
        */
        ...
        //Gizmos.DrawSphere(transform.TransformPoint(newCal3 ), .02f);
        ...
        //shadow Positon
        Vector3 centerCal = new Vector3(newCal3.x + newCal.x, cal.y * .899f,  newCal3.z - (newCal3.z - newCal.z) * 0.5f);
        ...
        */
        ...
        Vector3 newCal6 = new Vector3(cal6.x * .899f, cal6.y * .899f, gameObject.transform.position.z + cal6.z * .899f);
        ...
        //shadow Positon
        Vector3 centerCal2 = new Vector3(newCal7.x + newCal5.x, cal5.y * .899f, newCal7.z - (newCal7.z - newCal5.z) * 0.5f);
        ...
        */
        ...
        Vector3 newCal10 = new Vector3(cal10.x * .899f, cal10.y * .899f, gameObject.transform.position.z + cal10.z * .899f);
        ...
        //shadow Positon
        Vector3 centerCal3 = new Vector3(newCal11.x + newCal9.x, cal9.y * .899f, newCal11.z - (newCal11.z - newCal9.z) * 0.5f);
